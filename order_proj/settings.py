...
WSGI_APPLICATION = "order_proj.wsgi.application"
...
MIN_BOOKING_DURATION = float(os.getenv("MIN_BOOKING_DURATION", 60 * 60))
MAX_BOOKING_DURATION = float(os.getenv("MAX_BOOKING_DURATION", 60 * 60 * 24 * 7))
